...
void main() {
  group('WebView Inspector', () {
    ...
    test('script history manager initializes with default scripts', () {
      ...
      expect(history.any((h) => h.script == 'console.log("Hello World");'), true);
    ...
    test('script history manager can add new scripts', () {
      ...
      final uniqueScript = 'console.warn("unique test script ${DateTime.now().millisecondsSinceEpoch}");';
    ...
    test('script history manager can clear history', () {
      ...
      expect(manager.history.any((h) => h.script == 'console.log("Hello World");'), true);
    });
  });
}
