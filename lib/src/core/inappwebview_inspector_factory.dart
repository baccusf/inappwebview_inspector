...
class InAppWebViewInspectorFactory {
  ...
  static InAppWebViewInspectorConfig _config =
      InAppWebViewInspectorConfig.defaultConfig;
  ...
  static InAppWebViewInspectorInterface createInstance(
...
class InAppWebViewInspectorService {
  ...
  static InAppWebViewInspectorInterface get inspector {
    ...
    if (inspector == null) {
      throw StateError(
          'InAppWebViewInspector not registered. Call InAppWebViewInspectorService.register() first.');
    }
    return inspector;
  }
...
extension InAppWebViewInspectorExtension on InAppWebViewInspectorInterface {
  ...
  List<InAppWebViewInspectorConsoleMessage> getConsoleLogsForWebView(
      String webViewId) {
